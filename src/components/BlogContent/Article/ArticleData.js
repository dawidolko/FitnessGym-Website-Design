const articleData = [
  ...
  },
  {
    ...
    highlight:
      "Consistency and knowledge are the cornerstones of fitness success.",
    text2:
      "Explore the key aspects of fitness, including tailored workout plans and smart dietary choices. Stay informed about the latest trends and techniques to maximize your results. With consistency and dedication, you'll pave the way for a healthier, more active life.",
  },
  {
    id: 3,
    ...
    highlight: "Fitness is not just physical—it's mental and emotional too.",
    text2:
      "Incorporate regular workouts into your routine to benefit both your body and mind. Exercise releases endorphins that elevate your mood and sharpen cognitive abilities, helping you approach challenges with clarity and positivity.",
  },
  {
    id: 4,
    ...
    highlight:
      "Today is the perfect day to make fitness a priority—don't wait for tomorrow.",
    text2:
      "Delaying your fitness journey only postpones your progress. Begin today, and set the foundation for a healthier, more fulfilling future. Small steps lead to significant results.",
  },
  {
    id: 5,
    ...
    text2:
      "Tailor your fitness plan to your needs and preferences. Understand the basics, focus on consistency, and prioritize your health. This is your guide to a sustainable and rewarding fitness journey.",
  },
  {
    id: 6,
    ...
    highlight: "To train like a champion, think like one first.",
    text2:
      "Understand the mindset and habits of elite athletes. Embrace disciplined training, balanced nutrition, and mental resilience to push your limits and achieve your goals.",
  },
];
